export const translations = {
  en: {
    ...
    proRataBasePriceLabelBeforeTax: "Base monthly price (before VAT)",
    proRataProrationBasePriceLabel: "Base Price for Proration (Pre-Discount)",
    ...
    proRataAddOnsTotalBeforeTax: "Add-ons total (before VAT)",
    proRataMonthlyNet: "Monthly net",
    proRataMonthlyAfterTax: "Monthly after VAT",
    proRataProAmount: "Pro-Rata amount",
    proRataProAmountAfterTax: "Proration (after VAT)",
    proRataInvoice: "First invoice",
    proRataInvoiceAfterTax: "First invoice (after VAT)",
    ...
    pdf: {
      ...
      amounts: {
        ...
        monthlyAfterTax: "Monthly after VAT",
        proRataAfterTax: "Proration after VAT",
        firstInvoiceAfterTax: "First invoice after VAT",
        badge: "All-inclusive",
      },
      script: {
        callMode: "Call mode",
  ...
  ar: {
    ...
    proRataBasePriceLabelBeforeTax: "السعر الشهري الأساسي (قبل الضريبة)",
    proRataProrationBasePriceLabel: "سعر الأساس للنسبة والتناسب (قبل الخصم)",
    ...
    proRataAddOnsTotalBeforeTax: "مجموع الإضافات (قبل الضريبة)",
    proRataMonthlyNet: "الصافي الشهري",
    proRataMonthlyAfterTax: "القيمة الشهرية بعد الضريبة",
    proRataProAmount: "قيمة النسبة",
    proRataProAmountAfterTax: "قيمة النسبة بعد الضريبة",
    proRataInvoice: "فاتورة البداية",
    proRataInvoiceAfterTax: "فاتورة البداية بعد الضريبة",
    ...
    pdf: {
      ...
      amounts: {
        ...
        monthlyAfterTax: "الشهري بعد الضريبة",
        proRataAfterTax: "النسبة بعد الضريبة",
        firstInvoiceAfterTax: "الدفعة الأولى بعد الضريبة",
        badge: "شامل",
      },
      script: {
